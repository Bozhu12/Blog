...
<img src="http://sanscan12.gitee.io/blogimg/Content/Git/02.png" style="zoom:67%;" />

## Git应用

### Git工作流程

![](http://sanscan12.gitee.io/blogimg/Content/Git/03.png)
...
![](http://sanscan12.gitee.io/blogimg/Content/Git/01.png)
...
1. 生成公钥 ，该 `Users/<你的电脑用户名>/.ssh/` 目录不存在需要生成公钥，在终端执行以下代码，然后一路按回车，账号密码暂时不需要
   ...
   <img src="http://sanscan12.gitee.io/blogimg/Content/Git/04.png" style="zoom: 33%;" />
2. 打开 `Users/<你的电脑用户名>/.ssh/id_rsa.pub` 复制内容 到 gitee 上
   <img src="http://sanscan12.gitee.io/blogimg/Content/Git/05.png" style="zoom: 33%;" />
3. gitee 进入 ，个人设置 -> 安全设置 -> SSH公钥 。或者 [点击添加公钥](https://gitee.com/profile/sshkeys) 
4. 填写信息，key值(标题) 自定义，将刚刚的内容粘贴到公钥里，添加即可
   <img src="http://sanscan12.gitee.io/blogimg/Content/Git/06.png" style="zoom: 33%;" />
5.  SSH连接，`$ git remote add <连接对象名> <SSH地址>`  进行连接
   <img src="http://sanscan12.gitee.io/blogimg/Content/Git/07.png" style="zoom:50%;" />
...
1. 下载插件 `gitee`
2. 在设置里搜 `Git` ，添加Git路径
   <img src="http://sanscan12.gitee.io/blogimg/Content/Git/08.png" style="zoom:50%;" />
3. 在设置里搜 `gitee` ，添加用户
   <img src="http://sanscan12.gitee.io/blogimg/Content/Git/09.png" style="zoom:33%;" />

**首次本地项目上传** 

<img src="http://sanscan12.gitee.io/blogimg/Content/Git/10.png" style="zoom:50%;" />

**首次仓库项目下载** 

<img src="http://sanscan12.gitee.io/blogimg/Content/Git/11.png" style="zoom: 33%;" />
